# with open("lesson_67_binary", 'bw') as bin_file:
#     bin_file.write(bytes(range(17)))

# with open("lesson_67_binary", 'br') as binFile:
#     for b in binFile:
#         print(b)
...
with open("lesson_67_binary2", 'bw') as bin_file:
...
with open("lesson_67_binary2", 'br') as bin_file:
